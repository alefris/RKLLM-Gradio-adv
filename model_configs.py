model_configs = {
    ...
    "Llama-3.1-8B-Instruct-128k": {
        "base_config": {
            "st_model_id": "c01zaut/Llama-3.1-8B-Instruct-rk3588-1.1.2",
            "max_context_len": 35000,
            "max_new_tokens": 8192,
            "top_k": 20,
            "top_p": 0.9,
            "temperature": 0.5,
            "repeat_penalty": 1.1,
            "frequency_penalty": 0.3,
            "system_prompt": "You are Llama 3.1, an artificial intelligence model trained by Meta. You are a helpful assistant."
            },
        "models": {
            "Llama-3.1-8B-Instruct-128k": {"filename": "Llama-3.1-8B-Instruct-rk3588-w8a8_g512-opt-1-hybrid-ratio-0.0.rkllm"}
        }
    },
    ...
    "Phi-3.5-Mini-Instruct": {
        "base_config": {
            "st_model_id": "c01zaut/Phi-3-mini-4k-instruct-rk3588-1.1.4",
            "max_context_len": 4096,
            "max_new_tokens": 4096,
            "top_k": 1,
            "top_p": 0.9,
        ...
        "models": {
            "Phi-3.5-Mini-Instruct": {"filename": "Phi-3-mini-4k-instruct-rk3588-w8a8_g256-opt-0-hybrid-ratio-0.5.rkllm"},
        }
    },
    "Phi-3-Mini-Instruct-128k": {
        ...
        "models": {
            "Phi-3-Mini-128k-Instruct": {"filename": "Phi-3-mini-128k-instruct-rk3588-w8a8-opt-0-hybrid-ratio-0.0.rkllm"},
            "Phi-3-Mini-128k-Instruct-opt": {"filename": "Phi-3-mini-128k-instruct-rk3588-w8a8-opt-1-hybrid-ratio-0.0.rkllm"},
            "Phi-3-Mini-128k-Instruct-opt-hybrid-0.5": {"filename": "Phi-3-mini-128k-instruct-rk3588-w8a8-opt-1-hybrid-ratio-0.5.rkllm"}
        }
    },
    "Qwen-2.5-Instruct": {
        "base_config": {
    ...
    "Qwen-2.5-7B-Instruct-1M": {
        "base_config": {
            "st_model_id": "limcheekin/Qwen2.5-7B-Instruct-1M-rk3588-1.1.4",
            "max_context_len": 50000,
            "max_new_tokens": 8192,
            "top_k": 1,
            "top_p": 0.5,
        ...
        "models": {
            "Qwen-2.5-7B-Instruct-1M": {"filename": "Qwen2.5-7B-Instruct-1M-rk3588-w8a8_g128-opt-1-hybrid-ratio-0.0.rkllm"}
        },
    },
    "Qwen-2.5-14B-Instruct-1M": {
        "base_config": {
            "st_model_id": "Qwen/Qwen2.5-14B-Instruct-1M",
            "max_context_len": 50000,
            "max_new_tokens": 8192,
            "top_k": 1,
            "top_p": 0.5,
        ...
        "models": {
            "Qwen-2.5-14B-Instruct-1M": {"filename": "Qwen2.5-14B-Instruct-1M-rk3588-w8a8-opt-0-hybrid-ratio-0.0.rkllm"}
        },
    },
    "Qwen-2.5-Math-1.5B": {
        "base_config": {
    ...
    "Gemma-2-LongCoT-2B": {
        ...
        "models": {
            "Gemma2-OpenLongCoT-2B": {"filename": "OpenLongCoT-Base-Gemma2-2B-rk3588-w8a8-opt-1-hybrid-ratio-1.0.rkllm"}
        }
    },
    "Gemma-2-2B-it-Google": {
        ...
        "models": {
            "Gemma-2-2B-it-Google-g256": {"filename": "gemma-2-2b-it-rk3588-w8a8_g256-opt-0-hybrid-ratio-0.0.rkllm"},
            "Gemma-2-2B-it-Google": {"filename": "gemma-2-2b-it-rk3588-w8a8-opt-0-hybrid-ratio-0.0.rkllm"}
        }
    },
    "Gemma-2-9B-it-Google": {
        ...
        "models": {
            "Gemma-2-9B-it-Google": {"filename": "gemma-2-9b-it-rk3588-w8a8-opt-0-hybrid-ratio-0.0.rkllm"},
            "Gemma-2-9B-it-Google-g512": {"filename": "gemma-2-9b-it-rk3588-w8a8_g512-opt-1-hybrid-ratio-1.0.rkllm"}
        }
    },
    "InternLM-2.5-1.8B": {
        "base_config": {
    ...
    "InternLM-2.5-7B-1M": {
        "base_config": {
            "st_model_id": "internlm/internlm2_5-7b-chat-1m",
            "max_context_len": 70000,
            "max_new_tokens": 8192,
            "top_k": 30,
            "top_p": 0.8,
            "temperature": 0.5,
        ...
        "models": {
            "Internlm-2.5-7B-Chat-1M": {"filename": "internlm2_5-7b-chat-1m-rk3588-w8a8-opt-0-hybrid-ratio-0.0.rkllm"}
        }
    },
    "Deepseek-Chat-7B": {
        "base_config": {
    ...
    "DeepSeek-R1-Distill-Qwen-7B-32K": {
        "base_config": {
            "st_model_id": "ahz-r3v/DeepSeek-R1-Distill-Qwen-7B-rk3588-rkllm-1.1.4",
            "max_context_len": 32760,
            "max_new_tokens": 32760,
            "top_k": 40,
            "top_p": 0.9,
            "temperature": 0.6,
            "repeat_penalty": 1.2,
        ...
        "models": {
            "DeepSeek-R1-Distill-Qwen-7B-32K": {"filename": "DeepSeek-R1-Distill-Qwen-7B_W8A8_RK3588_o0.rkllm"}
        }
    },
    "MiniCPM3-4B": {
        "base_config": {
