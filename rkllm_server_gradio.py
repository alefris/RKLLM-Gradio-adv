...
if __name__ == "__main__":
   ...
   #Controls the resource monitor panel update frequency and style.
    resmon_frequency=2
    resmon_style='simple'   #Set full otherwise
